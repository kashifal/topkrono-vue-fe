<template>
  ...
  <div>
      ...
      >
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
          <nav class="">
            <div class="relative flex h-16 justify-between">
              ...
              >
                ...
                <div class="hidden md:ml-6 md:flex sm:space-x-8">
                  <a
                    href="#"
                    @click="desktopServices"
                    class="inline-flex items-center border-b-2 border-indigo-500 px-1 pt-1 text-sm text-gray-900 whitespace-nowrap relative"
                    >Services</a
                  >
                  <div
                    :class="isDeskServiceOpen === true ? 'block' : 'hidden'"
                    class="absolute left-20 max-w-3xl w-1/4 border rounded-md bg-white mt-16"
                    id="mobile-menu"
                  >
                    <div class="space-y-1 pb-4 pt-2">
                      ...
                      <a
                        href="#"
                        class="block border-l-4 border-transparent py-2 pl-3 pr-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700"
                        >Garage Door Repair a tech</a
                      >
                      <router-link
                        to="/plumbing"
                        class="block border-l-4 border-transparent py-2 pl-3 pr-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700"
                        >Plumbing Service</router-link
                      >
                    </div>
                  </div>
                  <a
            ...
            <div
              :class="isMenuOpen === true ? 'block' : 'hidden'"
              id="mobile-menu"
            >
              <div class="space-y-1 pb-4 pt-2">
                <a
                ...
                >
                <div
                  :class="isServiceOpen === true ? 'block' : 'hidden'"
                  class="bg-white rounded-md space-y-1 pb-4 pt-2 px-4"
                >
                  <a
                    href="#"
                    class="block border-l-4 border-indigo-500 bg-indigo-50 py-2 pl-3 pr-4 text-sm font-medium text-indigo-700"
    ...
    <div class="max-w-7xl mx-auto">
        ...
        >
          <div class="">
            ...
            <p class="text-lg">
              ...
              >
              <br />
              Our hybrid home warranty and home services membership offers
              comprehensive coverage for your home appliances and systems and
              gives you 15% off all Puls home services year-round.
            </p>
          </div>
          <div class="">
            <svg
      ...
      <section>
        <div
          class="bg-gradient-to-r from-cyan-500 to-blue-300 p-4 rounded-3xl mt-24"
        >
          <div class="grid md:grid-cols-2">
            <div class="space-y-3 max-w-xl px-12 py-12">
              ...
              <div
                class="pt-2 relative max-w-xl mr-auto text-gray-600 bg-white rounded-lg"
              >
                <input
                  class="w-full h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"
                  type="search"
                  name="search"
                  placeholder="What home service do you need?"
                />
                <button type="submit" class="absolute right-0 top-0 mt-5 mr-4">
                  <svg
                    class="text-cyan-500 h-4 w-4 fill-current"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink"
                    version="1.1"
                    id="Capa_1"
          ...
          <div class="mt-24 mb-8">
            <div class="flex overflow-x-auto mb-5 shadow-md gap-10">
              <div
                class="flex-shrink-0 bg-white rounded-lg max-w-xs w-full py-4 px-4 text-center"
              >
                <img
                  class="w-36 h-20 mx-auto object-contain"
                  :src="Handyman"
                  alt=""
                />
                ...
                <div class="space-y-5">
                  ...
                  <div class="flex flex-wrap gap-2 justify-center items-center">
                    <a
                      class="bg-blue-200 rounded-3xl text-xs px-2 py-1 text-gray-800"
                      href=""
                      >Drywall Repair</a
                    >
                    <a
      ...
      <section>
        <div
          class="bg-gradient-to-r from-violet-500 to-fuchsia-500 my-24 py-12 px-6 rounded-3xl"
        >
          <div>
            <div class="grid grid cols-1 md:grid-cols-3 gap-5">
              <div
                class="flex flex-col bg-white border border-gray-300 p-4 rounded-3xl shadow-lg"
              >
      ...
      <section>
        <div
          class="bg-gradient-to-r from-purple-500 to-blue-300 p-6 rounded-3xl my-24"
        >
            ...
            <div class="max-w-3xl flex flex-wrap md:flex-nowrap items-center">
              <div class="">
                ...
                <p class="text-white text-sm">
                  Book once for your immediate needs or sign up for a membership
                  to save up to 15% on all your home service needs year-round.
                </p>
              </div>
              <div class="md:-mt-32">
                <svg
                  ...
                  width="100%"
                  height="300"
                  viewBox="0 0 731.66998 619.11871"
                  xmlns:xlink="http://www.w3.org/1999/xlink"
                >
                  <path
                  ...
                  />
                  <path
                    id="uuid-bcebe549-af57-499c-bd7d-dc350147856d-35"
                  ...
                  />
                  <path
                    id="uuid-56498841-4b1e-4105-a308-6339b9438744-36"
          ...
          <div
            class="flex flex-wrap md:flex-nowrap gap-4 items-center max-w-3xl py-12"
          >
            <div class="-ml-6">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="my-12">
              <p class="text-white font-medium">
                2. Instant booking with crazy fast service
              </p>
              <p class="text-white text-sm">
                Book your appointment and Puls' predictive match technology will
                connect you with a reliable, background checked technician who
                will arrive as early as same day.
              </p>
            </div>
          </div>
          <div
            class="max-w-3xl ml-auto flex flex-wrap md:flex-nowrap items-center justify-end mt-12"
          >
            <div class="">
              <p class="text-white font-medium">
                3. Sit back, we’ve got you covered
              </p>
              <p class="text-white text-sm">
                We aim to provide the best possible customer experience. Rest
                easy knowing all repairs are backed by our 90-day guarantee.
                Protection and Click & Fix plan members get an extended
            ...
            <div class="w-[500px] h-56">
              ...
              >
                <defs>
                  <linearGradient
                    id="af83dc26-9572-4816-b7a1-1af4f72ff554-85"
                    x1="678.2"
                    y1="821.79"
                    x2="678.2"
                    y2="493.4"
                ...
                <path
                  ...
                  transform="translate(-88.65 -57.09)"
                  fill="url(#af83dc26-9572-4816-b7a1-1af4f72ff554-85)"
                />
                <path
...
const isDeskServiceOpen = ref(false);
...
function desktopServices() {
  isDeskServiceOpen.value = !isDeskServiceOpen.value;
}
</script>
