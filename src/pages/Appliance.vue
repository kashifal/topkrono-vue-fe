<template>
          ...
          <section class=" flex items-center justify-between">
            <div class="space-y-6 w-auto md:w-1/4 px-4">
              <h3 class="text-5xl font-bold text-[#52575a]">
                <span class="text-[#224386]">Appliance</span> Installation And Repair
              </h3>
  ...
  import myImage from "../assets/appliancemain.webp";
  import infoImage from "../assets/dealplumber.png";
  import boyImage from "../assets/Appliancecar.jpg"; 
